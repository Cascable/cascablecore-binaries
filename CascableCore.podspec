Pod::Spec.new do |s|
  ...
  s.source                   = { :http => "https://github.com/Cascable/cascablecore-binaries/releases/download/4.2/CascableCore.framework.zip" }

  s.subspec 'Mac' do |mac|
    mac.vendored_frameworks       = 'Binaries/Mac/CascableCore.framework'
    mac.platform                  = :osx
    mac.osx.deployment_target     = '10.11'
  end

  s.subspec 'iOS' do |ios|
    ios.vendored_frameworks       = 'Binaries/iOS/CascableCore.framework'
    ios.platform                  = :ios
